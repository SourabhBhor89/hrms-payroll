...
(
    ...
    total_hours DOUBLE PRECISION NULL DEFAULT 0.0,
...
(
    ...
    requested_clock_out TIMESTAMP NOT NULL,
    original_working_hours DOUBLE PRECISION NULL DEFAULT 0.0,
    requested_working_hours DOUBLE PRECISION NULL DEFAULT 0.0,
...
VALUES
    ('ATTENDANCE_REGULARIZATION_CREATE', 'Can submit and cancel attendance regularization requests', NOW(), NOW()),
    ('ATTENDANCE_REGULARIZATION_VIEW_ALL', 'Can view all attendance regularization requests', NOW(), NOW()),
    ('ATTENDANCE_REGULARIZATION_APPROVE', 'Can approve or reject attendance regularization requests', NOW(), NOW())
